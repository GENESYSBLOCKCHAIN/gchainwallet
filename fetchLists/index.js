...
const fetchContracts = async () => {
  try {
    ...
    const contractFileURL =
      'https://raw.githubusercontent.com/danielvindax/ethereum-lists/gsys/dist/contracts/';
...
const fetchMasterFile = async () => {
  try {
    ...
    const response = await fetch(
      'https://raw.githubusercontent.com/danielvindax/ethereum-lists/gsys/dist/master-file.json'
    )
      .then(res => res.json())
      .then(tokens => {
        const networkTokens = {};
