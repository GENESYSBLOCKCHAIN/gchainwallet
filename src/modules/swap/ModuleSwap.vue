    ...
    <mew6-white-sheet>
      ...
      >
        <template v-if="isAvailable" #moduleBody>
          ...
          <!--
          =====================================================================================
            User Message Block: store your Bitcoin on The GSYS Chain
          =====================================================================================
          -->
          <app-user-msg-block
            v-if="!hasMinEth"
                ...
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content color="greyLight" class="pa-0">
                    <div class="textLight--text mb-2">
                      ...
                      Bitcoin in GenesysWallet, you can swap to wrapped Bitcoin
                      instead. Wrapped Bitcoin is an The GSYS Chain token, with
                      a approximately equal to 1 BTC. Wrapped Bitcoins can be
                      stored in Gwallet, and can be used as any other The GSYS
                      Chain asset: asset: you can swap it to other tokens, use
                      it as collateral in DeFi apps, etc. There are multiple
                      kinds of wrapped Bitcoins, but they roughly do the same
                      thing.
                      <a
  ...
  data() {
    return {
      swapNotAvailableMes: {
        ...
        subtitle: 'Please select ETH networks to use this feature.'
      },
      step: 0,
      confirmInfo: {
        to: '',
