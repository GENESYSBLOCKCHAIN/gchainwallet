<template>
  <div
    class="mew-component--create--mnemonic-phrase"
    style="max-width: 800px; display: contents"
  >
      ...
      <template v-if="step === 3" #stepperContent3>
        <div class="d-flex align-center">
          <div>
            ...
            <p class="mb-6">
              You are now ready to take advantage of all that The GSYS Chain has
              to offer! Access with mnemonic phrase should only be used in an
              offline setting
            </p>
            <v-img
