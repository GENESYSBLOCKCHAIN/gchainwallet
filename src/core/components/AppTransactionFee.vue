    ...
    >
      <template #dialogBody>
        ...
        <div class="mt-6 textLight--text">
          Transaction fees are charged by The GSYS Chain miners, not Gwallet. We
        ...
        <div class="mt-6 textLight--text">
          ...
          Gwallet supports The GSYS Chain scaling solutions Polygon and Binance
          Smart (accessible on Gwallet web and Android). Consider using these
      ...
      -->
        <div class="d-flex align-center justify-space-between flex-wrap mb-2">
          <div class="d-flex align-center flex-wrap flex-grow-1">
            ...
            <div class="mew-heading-3 ml-2">Transaction fee:</div>
            <div
          ...
          <div v-if="fromEth">
            <div class="py-1 ml-2 text-right">
