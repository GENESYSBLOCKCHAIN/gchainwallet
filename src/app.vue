  ...
  methods: {
    ...
    logMessage() {
      ...
      console.log(
        ...
        '\n\nOn the other hand, if you are a developer and do know what you’re doing, Gwallet is hiring and we probably want to talk to you. Send us an email at careers@genesyswallet.io with the subject line: I am a software developer.'
      );
