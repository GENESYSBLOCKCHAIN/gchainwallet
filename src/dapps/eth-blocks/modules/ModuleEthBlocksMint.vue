        ...
        <v-col cols="12">
          ...
          <div class="text-center">
            <v-img
              ...
              class="mt-8 mt-md-0"
            />
            <div class="mt-5 mb-2 mew-heading-1">GSYS Blocks</div>
            <h4 class="mb-8 textMedium--text">
              Own the unownable. Mint your very own unique QR NFT of a specific
              block on the Loop blockchain. From Genesis, to the block of first
              crypto transaction, or the block that took you to the moon. moon.
              Forge a piece of crypto history with a GSYS Blocks.
            </h4>
          </div>
        </v-col>
      </v-row>
