...
The best way to start an integration is by creating a fork of GenesysWallet and using it for your development.
...
### How to Start
    ...
    $ git clone git@github.com:GenesysWallet/GenesysWallet.git
...
If you have any issue, you can always contact us or you can create an issue in our Github [repository](https://github.com/GenesysWallet/GenesysWallet).
