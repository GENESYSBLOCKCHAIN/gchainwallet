...
export default {
  ...
  data() {
    return {
      ...
      userTermsLabel:
        'I understand that Gwallet has no control over any assets I choose to associate with these keys and willingly assume all risk of loss, including those coming as a result of protocol or key failure.'
    };
  },
  computed: {
    /**
