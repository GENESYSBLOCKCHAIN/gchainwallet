...
export default {
  ...
  data() {
    return {
      ...
      keystoreFileWarning:
        "Don't lose your Keystore file / password and Recovery phrase. They hold your keys and are necessary future access. Gwallet will not be able to recover them for you so make sure to keep them safe.",
      keystoreJson: '',
      keystoreName: '',
