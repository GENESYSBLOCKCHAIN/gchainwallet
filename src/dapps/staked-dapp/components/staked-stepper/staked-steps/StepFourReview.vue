    ...
    -->
      <div class="mt-5">
        ...
        >
          ...
          <div>
            {{ fee.ethValue }} <span class="textLight--text">GSYS /</span>
            {{ fee.fiatValue }}
          </div>
        </div>
      </div>
        ...
        >
          <template #contentSlot>
            <span
              ...
              and Gwallet is not liable for it's services.</span
            >
          </template>
        </mew-checkbox>
      </div>
        ...
        <div v-if="stakedStep === 1">
          ...
          >
            ...
            <a
              ...
              href="mailto:support@genesyswallet.io"
              target="_blank"
            >
...
export default {
  ...
  data() {
    return {
      ...
      stakedStep1Title: {
        message:
          'We will prepare validators for you. After that you can confirm and stake your GSYS.'
      }
    };
  },
  computed: {
      ...
      if (newVal.success) {
        ...
        if (
          ...
          this.stakedStep1Title = {
            message:
              'Oops. We don’t know how you got this far without enough GSYS. Please start over and check your funds.',
            error: true
          };
        } else {
          this.stakedStep1Title = {
