...
export default {
  ...
  data: () => ({
    titleData: {
      ...
      title: 'Swap',
      description:
        'Gwallet has partnered with 1inch, DEX AG, Changelly, Bity, and Simplex for easy crypto purchases and swaps. Buy ETH right in the wallet, swap ETH for ERC20 tokens, BTC and more!',
      centered: false
    }
  })
};
