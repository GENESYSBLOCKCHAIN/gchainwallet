        ...
        <div class="pa-5 pb-3">
          <div class="mt-2 mb-4 d-flex align-center justify-space-between">
            ...
            <router-link :to="{ name: ROUTES_WALLET.DASHBOARD.NAME }">
              <img width="120" src="@/assets/images/icons/logo-mew-white.png" />
            </router-link>
    ...
    >
      <v-row class="pa-3 align-center justify-space-between">
        ...
        <router-link
          ...
          style="line-height: 0"
        >
          <img height="26" src="@/assets/images/icons/logo-mew.png" />
        </router-link>
        <v-spacer />
...
export default {
  ...
  data() {
    return {
      ...
      routeNetworks: {
        [ROUTES_WALLET.SWAP.NAME]: [SARDIS]
        // [ROUTES_WALLET.NFT_MANAGER.NAME]: [SARDIS]
      },
  ...
  methods: {
    ...
    checkKYC() {
      ...
      form1.append(
        'authorization',
        'TMIneluB250H4MB00wsIKMQRsZw1Ye3ENObBG1lQhRY'
      );
      axios({
        method: 'post',
        url: 'https://kyc.sardisnetwork.com/index.php?route=api/wallet',
        data: form,
        headers: {
          authorization:
        ...
        .then(response => {
          if (response.data.success == true) {
            this.isVerified = response.data.kyc_status;
          }
          //  else {
