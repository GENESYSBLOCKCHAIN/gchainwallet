<template>
  <div class="mew-component--jobs">
    ...
    <the-layout-header
      title="Join Us"
      subtitle-line-one="At Gwallet we're on a mission to make crypto and the blockchain more accessible for everyone. Join us in creating the technology and systems of the future. "
    />
    ...
    <v-container class="my-15">
      ...
      -->
      <div class="mb-15">
        <div class="pa-3 mew-heading-1 text-center">Why Join Gwallet?</div>
        <div class="mx-auto text-center" style="max-width: 600px">
          ...
          offer all our employees a fantastic work experience. At Gwallet, we
          truly respect the work/life balance. With a strong emphasis on a great
      ...
      <div class="mb-12">
        ...
        <div class="mx-auto text-center" style="max-width: 600px">
          Email us at
          <a href="mailto:careers@genesyswallet.io" target="_blank">
            careers@genesyswallet.io
          </a>
