...
export default {
  ...
  data: () => ({
    titleData: {
      textProps: '',
      toptitle: '',
      title: 'Meet the #MLWteam',
      description:
        'GenesysWallet is a group of talented, inspiring, and hardworking individuals from around the world. We share the passion to code, create, and ultimately build an open, accessible and fair financial future, one piece of software at a time.',
      centered: true
    },
    team: [
