<template>
  <v-container class="py-12">
    <h1 class="mb-5 text-center">GenesysWallet security policy</h1>
    <p>
      GenesysWallet (Gwallet) looks forward to working with the security
      community to identify vulnerabilities in order to keep our users and
      Gwallet safe.
    </p>
    <p>
      Gwallet is passionate about providing a seamless and secure experience to
      our community. We are devoted to protecting our users private information
      and providing them an opportunity to interact with the The GSYS Chain
      blockchain in the safest manner possible. Security is our first priority
      and obligation and we always appreciate the valuable contributions! If you
      have any information regarding security vulnerabilities on the
      <strong>
        GenesysWallet website, Gwallet wallet App, MLWconnect App and Gwallet CX
      </strong>
      report it to
      <a href="mailto:bugbounty@genesyswallet.io">
        bugbounty@genesyswallet.io
      </a>
      according to our guidelines (jump to reporting rules)!
    </p>
    <p>
      Any vulnerabilities submitted under this policy will be used for the
      purposes of improving GenesysWallet security as well as the user
      experience. We aim to establish a positive feedback between Gwallet and
    ...
    <div class="mb-3">
      ...
      <ul class="pl-5">
        <li>Gwallet wallet App (Beta version Included)</li>
        <li>MLWconnect App (Beta version Included)</li>
        <li>Current live version of GenesysWallet . com</li>
        <li>Gwallet CX</li>
      </ul>
    </div>
    <p>
      <strong>
        ...
        conditions before conducting any testing for Gwallet and before
        submitting a report.
      </strong>
    </p>
    <p>Thank you.</p>
    <table class="main-table my-12">
      <tbody>
        <tr>
          ...
          <td class="pa-5">
            <div>
              <strong>GenesysWallet.com</strong>
              <div class="pl-5">
                Code base can be found:
                <a
                  href="https://github.com/GenesysWallet/GenesysWallet"
                  target="_blank"
                >
                  https://github.com/GenesysWallet/GenesysWallet
                </a>
              </div>
            </div>
            <div class="mt-3">
              <strong>Gwallet wallet App</strong>
              <div class="pl-5">
                Code base can be found:
                <ul class="px-5">
                  <li>
            ...
            <div class="mt-3">
              <strong>MLWconnect App</strong>
              <div class="pl-5">
                Code base Android:
                <a
                  href="https://github.com/GenesysWallet/MLWconnect-Android"
                  target="_blank"
                >
                  https://github.com/GenesysWallet/MLWconnect-Android
                </a>
                <br />
                Code base iOS:
                <a
                  href="https://github.com/GenesysWallet/MLWconnect-iOS"
                  target="_blank"
                >
                  https://github.com/GenesysWallet/MLWconnect-iOS
                </a>
                <br />
                iOS store:
                <a
                  href="https://apps.apple.com/us/app/MLWconnect/id1391097156"
                  target="_blank"
                >
                  https://apps.apple.com/us/app/MLWconnect/id1391097156
                </a>
                <br />
                Android:
                <a
                  href="https://play.google.com/store/apps/details?id=com.myetherwallet.MLWconnect"
                  target="_blank"
                >
                  https://play.google.com/store/apps/details?id=com.myetherwallet.MLWconnect
                </a>
              </div>
            </div>
            <div class="mt-3">
              <strong>Gwallet CX</strong>
              <div class="pl-5">
                Code base can be found:
                <a
                  href="https://github.com/GenesysWallet/GenesysWallet"
        ...
        <tr>
          ...
          <td class="pa-5">
            <div>
              ...
              decisions are up to the discretion of GenesysWallet.
              <strong>
        ...
        <tr>
          ...
          <td class="pa-5">
            <div>
              GenesysWallet will make a best effort to meet the following SLAs
        ...
        <tr>
          ...
          <td class="pa-5">
            ...
            <div class="mb-2">
              <strong>GenesysWallet Website and Gwallet CX:</strong>
            </div>
            <ul class="mb-3 px-5">
              <li>Clickjacking</li>
              <li>XSS</li>
            ...
            <div class="mb-2">
              <strong>Gwallet wallet and MLWconnect apps:</strong>
            </div>
            <ul class="px-5">
          ...
          <td class="pa-5">
            ...
            <ul class="px-5">
              ...
              <li>
                ...
                GenesysWallet.com. Gwallet will determine at its discretion
                whether a vulnerability is eligible for a reward and the amount
                of the award.
              </li>
        ...
        <tr>
          <td class="pa-5">Gwallet wallet and MLWconnect Mobile App</td>
          <td class="pa-5">
            <div>
              <ul class="px-5">
    ...
    <div>Thank you for helping keep GenesysWallet and our community safe!</div>
  </v-container>
</template>
